...
public class EntityListTableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int row, int col) {
        ...
        TicketMachine ticketMachine = entities.get(row);
        switch (col) {
            case 0:
                return ticketMachine.getMachineId();
            case 1:
                return ticketMachine.getLocation();
            case 2:
        ...
        switch (col) {
            case 0:
                try {
                    ...
                    ticketMachine.setMachineId(val);
                } catch (NumberFormatException ex) {
                }
                break;
            case 1:
                ticketMachine.setLocation(value.toString());
                break;
            case 2:
