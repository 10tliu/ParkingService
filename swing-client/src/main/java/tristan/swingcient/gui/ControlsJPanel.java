...
import tristan.swingcient.EntityListTableModel;
import tristan.swingcient.ModelController;
...
public class ControlsJPanel extends javax.swing.JPanel {
    ...
    public ControlsJPanel(ModelController modelController) {
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                ticketMachine.setLocation(field_A);
                ticketMachine.setStayType(field_B);
                ticketMachine.setField_C(field_C);
                try {
                    ticketMachine.setMachineId(Integer.parseInt(entityIdstr));
                } catch (NumberFormatException ex) {

                }
                entityFieldsJPanel1.setModelTicketMachine(ticketMachine);
    ...
    private void initComponents() {
        ...
        entityFieldsJPanel1 = new tristan.swingcient.gui.EntityFieldsJPanel();
    ...
    private void clearSearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearSearchButtonActionPerformed
        ...
        TicketMachine templateTicketMachine = new TicketMachine();
        entityFieldsJPanel1.setModelTicketMachine(templateTicketMachine);
        ...
        SwingWorker worker = new SwingWorker<String, Void>() {
            ...
            public String doInBackground() {
                ...
                m_modelController.findMatchingSearch(templateTicketMachine);
                return null;
            }
    ...
    private void findMatchingButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findMatchingButtonActionPerformed
        ...
        TicketMachine templateTicketMachine = entityFieldsJPanel1.getModelTicketMachine();
        jTable1.clearSelection();
        // running query in seperate thread 
        SwingWorker worker = new SwingWorker<String, Void>() {
            @Override
    ...
    private tristan.swingcient.gui.EntityFieldsJPanel entityFieldsJPanel1;
