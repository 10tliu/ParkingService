 ...
 */
package tristan.swingcient.gui;
...
public class EntityFieldsJPanel extends javax.swing.JPanel {
    ...
    private TicketMachine modelTicketMachine = new TicketMachine();

    public TicketMachine getModelTicketMachine() {

        if ("".equals(jTextField_A.getText())) {
            this.modelTicketMachine.setLocation(null);
        } else {
            this.modelTicketMachine.setLocation(jTextField_A.getText());
        }

        if ("".equals(jTextField_B.getText())) {
            this.modelTicketMachine.setStayType(null);
        } else {
            this.modelTicketMachine.setStayType(jTextField_B.getText());
        }

        if ("".equals(jTextField_C.getText())) {
            this.modelTicketMachine.setField_C(null);
        } else {
            this.modelTicketMachine.setField_C(jTextField_C.getText());
        }

        String intText = jTextField_id.getText();
        try {
            Integer id = Integer.parseInt(intText);
            this.modelTicketMachine.setMachineId(id);
        } catch (NumberFormatException e) {
            // should not happen because checked 
        }
        return modelTicketMachine;
    }

    public void setModelTicketMachine(TicketMachine modelTicketMachine) {
        LOG.debug("setting model entity to " + modelTicketMachine);
        this.modelTicketMachine = modelTicketMachine;
        jTextField_A.setText(this.modelTicketMachine.getLocation());
        jTextField_B.setText(this.modelTicketMachine.getStayType());
        jTextField_C.setText(this.modelTicketMachine.getField_C());

        String idtxt = (modelTicketMachine.getMachineId() == null) ? null : modelTicketMachine.getMachineId().toString();
    ...
    private void jTextField_idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_idActionPerformed
        ...
        try {
            ...
            this.modelTicketMachine.setMachineId(null); // should not happen because checked
        }
