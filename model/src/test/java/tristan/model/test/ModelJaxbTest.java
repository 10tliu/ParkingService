...
public class ModelJaxbTest {
    ...
    public void testJaxb() {
        ...
        try {
            ...
            JAXBContext jaxbContext = JAXBContext.newInstance("tristan.model");
            ...
            List<TicketMachine> entities = replyMessage1.getTicketMachineList().getEntities();
