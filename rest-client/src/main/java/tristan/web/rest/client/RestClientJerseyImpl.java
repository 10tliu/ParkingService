...
public class RestClientJerseyImpl implements RestInterface {
    ...
    public ReplyMessage retrieveMatchingEntites(TicketMachine ticketMachineTempate) {
        ...
        try {
            ...
            response = builder.post(javax.ws.rs.client.Entity.entity(ticketMachineTempate, mediaType));
    ...
    public ReplyMessage retrieveEntity(Integer id) {
        ...
        try {
            ...
            throw new RuntimeException("cannot run rest client to retrieveTicketMachine: Exception:", e);
        }
